...
$user_file_name1 =  $name.'.'.$ext;
  ...
  $query = "insert into forum (parent_id, type, date, element_name, img_path1) values ($parent_id, 1, ".date("YmdHis").", '$element_name', ";
   ...
   if ($action == 'del')
    {
      ...
      $result = @mysql_query("select * from forum where parent_id=$element_id");
 ...
 while ($row = mysql_fetch_array($result))
  {
   echo '<tr valign="center" onmouseover="this.style.backgroundColor='; echo "'#EFEFEF'"; echo';" onmouseout="this.style.backgroundColor='; echo "'white'"; echo ';" class="underline">
           ...
           &nbsp;<a href="javascript:sw(\'/admin/editors/edit_forum_group.php?id='.$row['element_id'].'\');"><img align="absmiddle" src="/admin/images/icons/pencil.png" border="0" alt="Редактировать элемент"></a>
           &nbsp;';
