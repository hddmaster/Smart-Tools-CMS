...
function save_position($element_id, $value)
{
  ...
  $text = '<table cellspacing="0" cellpadding="2">
            <tr>
              ...
              <td><a href="javascript:if(confirm(\'Вы действительно хотите удалить?\')){location.href=\'?delete_coodrinates=true&id='.$element_id.'\';}"><img src="/admin/images/icons/cross.png" alt="Удалить" border="0"></a></td>
            </tr>
           </table>';
